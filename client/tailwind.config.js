    ...
    extend: {
      colors: {
        prime: {
          ...
          hover:   '#16212E',
          card:    '#111D28',
          blue:    'rgb(var(--color-primary-rgb) / <alpha-value>)',
      ...
      backgroundImage: {
        ...
        'blue-glow':       'radial-gradient(ellipse 60% 40% at 50% 0%, rgba(var(--color-primary-rgb), 0.15) 0%, transparent 70%)',
      ...
      boxShadow: {
        ...
        'card-hover':  '0 20px 60px rgba(0,0,0,0.7), 0 0 0 1px rgba(var(--color-primary-rgb), 0.25)',
        'glow-blue':   '0 0 30px rgba(var(--color-primary-rgb), 0.35), 0 0 60px rgba(var(--color-primary-rgb), 0.15)',
        'glow-sm':     '0 0 12px rgba(var(--color-primary-rgb), 0.4)',
      ...
      keyframes: {
        ...
        pulseBlue: { '0%,100%': { boxShadow: '0 0 12px rgba(var(--color-primary-rgb), 0.3)' }, '50%': { boxShadow: '0 0 28px rgba(var(--color-primary-rgb), 0.6)' } },
      },
    },
  },
  plugins: [],
