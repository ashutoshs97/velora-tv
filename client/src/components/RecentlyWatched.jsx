      ...
      <div className="relative flex -mx-4 sm:-mx-6 lg:-mx-12">
        ...
        >
          {history.map((item) => (
            <div
              key={item._id}
              className="movie-card-container group/card snap-start flex-shrink-0 w-64 md:w-80"
            >
              <div className="movie-card-inner">
                ...
                <button
                  ...
                  className="absolute top-2 right-2 w-7 h-7 rounded-full bg-black/60 flex items-center justify-center 
                             opacity-0 group-hover/card:opacity-100 transition-opacity hover:bg-black/90 z-20 border border-white/20"
